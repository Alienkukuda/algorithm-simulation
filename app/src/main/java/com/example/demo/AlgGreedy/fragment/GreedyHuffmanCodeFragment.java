 ...
 */
public class GreedyHuffmanCodeFragment extends Fragment {

    private TextView tv;
    private FileUtil fileUtil = FileUtil.getInstance();

    public GreedyHuffmanCodeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_greedy_huffman_code, container, false);
        //获取tv
